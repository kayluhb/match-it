 ...
 * PROPORTIONAL_OUTSIDE, WIDTH_ONLY,</code> or <code>HEIGHT_ONLY</code>. Horizontally align
 ...
 */	
	public class LiquidArea extends AutoFitArea {
		 ...
		 * @param scaleMode Determines how the target should be scaled to fit the LiquidArea. ScaleMode choices are: <code>STRETCH, PROPORTIONAL_INSIDE, PROPORTIONAL_OUTSIDE, WIDTH_ONLY,</code> or <code>HEIGHT_ONLY</code>.
		 ...
		 */
		public static function createAround(target:DisplayObject, scaleMode:String=ScaleMode.PROPORTIONAL_INSIDE, hAlign:String=AlignMode.CENTER, vAlign:String=AlignMode.CENTER, previewColor:uint=0xFF0000, minWidth:Number=0, minHeight:Number=0, maxWidth:Number=99999999, maxHeight:Number=99999999, autoPinCorners:Boolean=true):LiquidArea {
			...
			la.attach(target, scaleMode, hAlign, vAlign);
			return la;
		}
